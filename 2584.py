...
class Game(tk.Frame):
    ...
    # This method was a collaborative effort between Cindy, Mirella and Anastazia
    def __init__(self):
    ...
    # This method was written by Mirella.
    ...
    # This method was written by Mirella and Cindy.      
    ...
    #This method was written by Cindy.
    def new_game(self):
        self.game_message = ""
    ...
    #This method was Anastazia, Mirella and Cindy.
    def setup_GUI(self):
    ...
    # This method was written by Anastazia.
    def GUI_update(self):
        for i in range(4):
            for j in range(4):
